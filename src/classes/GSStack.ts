...
import { GSSNode, _GSSNode } from './GSSNode'
...
export class GSStack<T> implements GSStack<T> {
  private levels: GSSLevel<T>[]
   ...
   */
  push(value: T, prev?: _GSSNode<T>): _GSSNode<T> {
